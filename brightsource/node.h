...
/********************* decleration part *****************/
#define VERTICAL_MOTOR_INTIAL 					45
#define HORIZONTAL_MOTOR_INTIAL 				0 
...
#define NODE_X_POSITION 									8		//change for each node postion
#define NODE_Y_POSITION 									2	  //change for each  node postion
...
extern int16_t hAngle;
/*vertical angle*/
extern int16_t vAngle;
/*current power value*/
...
extern uint16_t maxHPosition;
/*max power vertical position*/
extern uint16_t maxVPosition;
/*max power*/
...
//receiving queue
extern int8_t receiveBuffer[2];
extern uint8_t recBufferIndex;
...
/**/
extern uint16_t originalH;
extern uint16_t originalV;
